...
pub const KEYWORDS: [&str; 46] = [
    ...
    "attrs", "app", "case", "id", "match", "size", "load", "store", "ref", "deref", "cast", "dup",
    "drop", "panic", "Builtin", "Empty", "Atomic", "UInt", "Int", "Float", "Size", "Pointer",
    "Ref", "Char", "String", "Mem", "Path", "IO", "Ctx", "Sum", "Prod", "Sig", "Fun", "Attrs",
    "Type",
];
